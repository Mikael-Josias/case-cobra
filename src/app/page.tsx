    ...
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-6 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">What our <span className="relative px-2">customers<Icons.undeline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-green-500"/></span> say</h2>
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-5 stroke-[3px] text-green-600"/>
        ...
        <MaxWidthWrapper className="py-14">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              <div className="relative h-80 md:h-full w-full md:justify-self-end maxa-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <div className="flex justify-center">
              <Link href="/configure/upload" className={buttonVariants({size: "lg", className: "mx-auto mt-8"})}>Create your case now <ArrowRight className="h-4 w-4 ml-1"/></Link>
            </div>
          </ul>
        </MaxWidthWrapper>
      </section>
